...
public class IssueBooks extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cmbIssueSrch, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jLabel8)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtIsueSrch))
        );
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Issue Books", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Arial Rounded MT Bold", 1, 18), new java.awt.Color(111, 178, 70))); // NOI18N

        txtID.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "ID", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Calibri", 1, 14), new java.awt.Color(0, 204, 0))); // NOI18N

        txtBookNumber.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Book Number", javax.swing.border.TitledBorder.CENTER, javax.swing.border.TitledBorder.TOP, new java.awt.Font("Calibri", 1, 14), new java.awt.Color(0, 153, 0))); // NOI18N

        btnIssueBook.setBackground(new java.awt.Color(0, 102, 153));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addComponent(txtBookNumber, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
    ...
    private void tblReservedBooksMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblReservedBooksMouseClicked
        ...
        txtID.setText(tblReservedBooks.getValueAt(row, 0).toString());
        txtBookNumber.setText(tblReservedBooks.getValueAt(row, 1).toString());
    ...
    private void tblIssuedBooksMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblIssuedBooksMouseClicked
        ...
        if (row >= 0) {
            ...
            txtBookNumber.setText(bookNumberString);
        }
    ...
    private void btnIssueBookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIssueBookActionPerformed
        ...
        String id = txtID.getText().toLowerCase();
        if (bookNumber.length() > 0 && id.length() > 0) {
            int issuedBks=bookissueDetailBAL.getNoOfIssuedBooks(id);
            int reservedBks=bookissueDetailBAL.getNoOfReservedBooks(id);
            int book_Issue_limit=Integer.parseInt(PolicyBAL.getValue(Policy.policies.NO_OF_BOOK_ISSUE.toString()).getPolicyVal());
            
            if(issuedBks<book_Issue_limit){
            if (booksBAL.isAvailable(txtBookNumber.getText())) {
                if (studentTeacherBAL.isAvail(txtID.getText())) {
                    if (bookissueDetailBAL.isReserved(bookNumber)) {
                        if (bookissueDetailBAL.isReserved(bookNumber, id)) {
                            bookissueDetailBAL.issueReservedBook(bookNumber, id);
                            refresh();
                        } else {
                            JOptionPane.showMessageDialog(rootPane, "Reserved By SomeOne Else");
                        }
                    } else if (bookissueDetailBAL.isIssued(bookNumber)) {
                        JOptionPane.showMessageDialog(rootPane, "This Book is Already Issued");
                    } else {
                        bookissueDetailBAL.issueBook(bookNumber, id);
                        refresh();
                    }
                } else {
                ...
                JOptionPane.showMessageDialog(rootPane, "This Book is Not There");
            }
        }else{
            JOptionPane.showMessageDialog(rootPane,"According to policy you are not eligible to issue book on given id.\nAlready issued "+issuedBks+" Books & reserved "+reservedBks);
        } 
        }else {
            JOptionPane.showMessageDialog(rootPane, "Enter ID & BookNumber Both");
        }
