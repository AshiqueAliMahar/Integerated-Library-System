...
public class AdminForgotPass extends javax.swing.JInternalFrame {
    ...
    public AdminForgotPass(String email) {
        initComponents();
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addContainerGap())
                    .addComponent(lblSearch, javax.swing.GroupLayout.DEFAULT_SIZE, 194, Short.MAX_VALUE)))
        );
    ...
    private void lblSearchMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblSearchMouseClicked
        ...
        pinString = String.valueOf((int)(Math.random() * 10000));
        isEmailCorrect = generalBAL.isEmailCorrect(txtEmail.getText());

        if (isEmailCorrect) {
            email = txtEmail.getText();
            if (lbal.isEmail(email)) {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if (pwdPassword.getText().equals(pwdConfirmPasswod.getText()) && pinString.equals(txtConfirmCode.getText())) {
            ...
            if (isEmailCorrect) {
                if (lbal.isEmail(email)) {
                    lbal.setPassword(password, email);
                } else {
                    JOptionPane.showMessageDialog(null, "This Email Address is not there in Library");
                }
            }else{
                JOptionPane.showMessageDialog(null, "Enter Correct Format Of Email Address");
            }
        } else {
